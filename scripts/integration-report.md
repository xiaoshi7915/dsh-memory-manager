...
- 生成时间：2026-08-25T03:34:04.808Z
- 数据目录：`C:\Users\50251\AppData\Local\Temp\dsh-mem-verify-M6P096`
- 结论：**26/26 项通过**
...
| execute memory_add 成功 | ✅ | {"isError":false,"content":[{"type":"text","text":"已保存记忆（id=fe4383cd-2d0e-413b-a951-2e4d3e072bc8，嵌入=degraded，token=20）\n内容：我喜欢用 Python 做数据分析 |
| memory_add value 有 memory_id | ✅ |  |
| memory_add 渲染含中文 | ✅ |  |
| execute memory_search 成功 | ✅ | {"isError":false,"content":[{"type":"text","text":"检索「我平时用什么语言做数据分析」共 1 条，耗时 4ms：\n1. [47.4%] 我喜欢用 Python 做数据分析，常用 pandas 和 matplotlib。"}]," |
| memory_search 召回新增记忆 | ✅ | hit={"id":"fe4383cd-2d0e-413b-a951-2e4d3e072bc8","content":"我喜欢用 Python 做数据分析，常用 pandas 和 matplotlib。","score":0.4743,"session_id":"sess-A", |
...
| memory_stats 字段完整 | ✅ |  |
| execute memory_update_importance 成功 | ✅ | {"isError":false,"content":[{"type":"text","text":"已更新记忆 ed48a33b-59a8-4424-b628-cd26f2a9cefd 的重要性：5 → 9"}],"value":{"memory_id":"ed48a33b-5 |
