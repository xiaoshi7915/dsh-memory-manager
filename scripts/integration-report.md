...
- 生成时间：2026-08-25T08:32:06.439Z
- 数据目录：`C:\Users\50251\AppData\Local\Temp\dsh-mem-verify-g8wmsF`
- 结论：**40/40 项通过**
...
| execute mm_add 成功 | ✅ | {"isError":false,"content":[{"type":"text","text":"已保存记忆（id=79d744af-db1e-428c-81f8-bb35de4fd946，嵌入=degraded，token=20）\n内容：我喜欢用 Python 做数据分析 |
...
| mm_search 召回新增记忆 | ✅ | hit={"id":"79d744af-db1e-428c-81f8-bb35de4fd946","content":"我喜欢用 Python 做数据分析，常用 pandas 和 matplotlib。","score":0.4743,"session_id":"sess-A", |
| bare 别名 memory_search 可执行 | ✅ | {"isError":false,"content":[{"type":"text","text":"检索「我平时用什么语言做数据分析」共 1 条，耗时 4ms：\n1. [47.4%] 我喜欢用 Python 做数据分析，常用 pandas 和 matplotlib。"}]," |
...
| mm_stats 字段完整 | ✅ |  |
| execute mm_update_importance 成功 | ✅ | {"isError":false,"content":[{"type":"text","text":"已更新记忆 0c44a627-c10b-4a75-aa06-1f63d53c55c9 的重要性：5 → 9"}],"value":{"memory_id":"0c44a627-c |
