...
- 生成时间：2026-08-25T07:57:58.217Z
- 数据目录：`C:\Users\50251\AppData\Local\Temp\dsh-mem-verify-Tb49Pq`
- 结论：**34/34 项通过**
...
| execute mm_add 成功 | ✅ | {"isError":false,"content":[{"type":"text","text":"已保存记忆（id=a48362ca-eeb9-48f1-8687-e6ec7b484ea2，嵌入=degraded，token=20）\n内容：我喜欢用 Python 做数据分析 |
...
| mm_search 召回新增记忆 | ✅ | hit={"id":"a48362ca-eeb9-48f1-8687-e6ec7b484ea2","content":"我喜欢用 Python 做数据分析，常用 pandas 和 matplotlib。","score":0.4743,"session_id":"sess-A", |
...
| mm_stats 字段完整 | ✅ |  |
| execute mm_update_importance 成功 | ✅ | {"isError":false,"content":[{"type":"text","text":"已更新记忆 fba05bda-febb-4ae4-b8f0-60849eb70002 的重要性：5 → 9"}],"value":{"memory_id":"fba05bda-f |
